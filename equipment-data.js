...
const EQUIPMENT_DATA = [
    ...
    // Studio Speakers
    { id: 'SP-01', name: 'Genelec 7350 APM', amount: 1, description: 'Subwoofer / 8" / Peak 104 dB SPL / Power: 150 W / 22 - 120 Hz', price: 40, category: 'Studio Speakers', detailedDescription: 'Compact 8-inch active subwoofer designed for stereo and multichannel monitoring systems. Perfect for studio monitoring, post-production, and multichannel audio installations. Part of our multichannel system configuration alongside Genelec 8330 APM monitors and Fostex 6301B speakers. Extends low-frequency response down to 22 Hz for accurate bass reproduction in music production, film mixing, and immersive audio applications. Smart Active Monitoring technology integrates seamlessly with Genelec GLM software for room calibration and system optimization. Compact footprint suits small to medium control rooms, home studios, and mobile production setups.' },
    { id: 'SP-02', name: 'Genelec 8330 APM Pack', amount: 1, description: '2-Way Active Studio Monitors / 45 Hz - 23 kHz / Peak 110 dB', price: 60, category: 'Studio Speakers', detailedDescription: 'Compact two-way active studio monitors with Smart Active Monitoring technology. Perfect for professional music production, mixing, mastering, and broadcast applications. Ideal for small to medium control rooms, home studios, and mobile recording setups requiring accurate reference monitoring. Part of our multichannel system configuration with Genelec 7350 APM subwoofer and Fostex 6301B speakers. Features advanced DSP with room calibration via GLM software for optimized acoustic performance in any environment. Delivers precise stereo imaging and extended frequency response for critical listening applications in music production, post-production, and content creation.' },
    ...
    // Mixers
    { id: 'MX-01', name: 'Allen Heath SQ 5', amount: 1, description: 'Digital Mixer / 48-Channel Digital Mixer', price: 70, category: 'Mixers', detailedDescription: 'Professional 48-channel digital mixer designed for demanding live sound and installation applications. Perfect for medium to large venues, touring productions, theaters, houses of worship, and corporate events requiring extensive input capacity. Features advanced digital processing, built-in FX engines, and comprehensive routing capabilities. Touchscreen control provides intuitive workflow for complex mixing scenarios. Ideal for concert halls, festivals, conference centers, and multi-room installations. Remote control and app integration enable mixing from anywhere in the venue. Expandable I/O with digital stageboxes suits growing systems. Excellent for sound engineers requiring professional-grade digital mixing with extensive channel count and flexible configuration options.' },
    ...
    { id: 'MX-03', name: 'Allen & Heath AR2412 AudioRack', amount: 1, description: 'Digital Stagebox / 24 XLR mic / 12 XLR line outputs (L/R) / Cat 5', price: 40, category: 'Mixers', detailedDescription: 'Professional digital stagebox with 24 XLR mic inputs and 12 XLR line outputs. Perfect for expanding Allen & Heath digital mixer I/O to the stage, eliminating long analog cable runs. Ideal for theaters, concert venues, houses of worship, and touring productions requiring clean signal transport from stage to front-of-house. Cat5 connection enables digital audio transmission over long distances with zero signal degradation. Rugged 19-inch rack-mountable design suits both fixed installations and touring applications. Excellent for multi-room facilities, outdoor festivals, and large venues needing remote I/O expansion. Works seamlessly with Allen & Heath SQ and GLD series mixers for flexible system configurations.' },
    ...
    { id: 'MI-D-04', name: 'Shure PG58', amount: 2, description: 'Dynamic Vocal Microphone', price: 2, category: 'Microphones', detailedDescription: 'Rugged dynamic vocal microphone designed for lead and backup vocal performances. Perfect for live sound reinforcement, karaoke, rehearsals, and budget-conscious productions. Cardioid polar pattern reduces feedback in high-volume settings. Built-in on/off switch provides onstage control. Durable metal construction with hardened steel mesh grille withstands demanding touring and rental applications. Internal shock mount reduces handling noise during active performances. Tailored frequency response optimized specifically for vocal clarity. Ideal for bands, mobile entertainers, houses of worship, schools, and small venues requiring reliable, affordable vocal microphones.' },
    { id: 'MI-D-05', name: 'Shure C606', amount: 1, description: 'Dynamic Vocal Microphone', price: 2, category: 'Microphones', detailedDescription: 'Affordable entry-level dynamic cardioid microphone designed for karaoke, public speaking, and home recording. Perfect for casual vocal performances, presentations, and budget-friendly recording projects. Pronounced midrange with slight upper-mid boost enhances vocal clarity for speech applications. Built-in on/off switch provides convenient control. Durable metal construction with steel mesh grille suits semi-professional and casual live settings. Ideal for community centers, schools, karaoke venues, small events, and home studio use requiring reliable, cost-effective vocal microphone solutions.' },
    { id: 'MI-D-06', name: 'AKG D880', amount: 1, description: 'Dynamic Vocal / Instrument Microphone', price: 2, category: 'Microphones', detailedDescription: 'Rugged dynamic supercardioid microphone designed for on-stage instrumental and vocal pickup. Perfect for live performances requiring crisp instrumental clarity and improved speech intelligibility. Supercardioid pattern provides enhanced feedback immunity compared to standard cardioid mics. Ideal for amplified instruments, drum kits, brass sections, and live vocal applications. Very low handling noise through Doubleflex anti-vibration isolation system makes it excellent for active performers. High sensitivity delivers strong output for both vocals and instruments. Perfect for touring bands, live sound reinforcement, club performances, and theater productions requiring versatile, feedback-resistant microphones.' },
