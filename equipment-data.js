...
const EQUIPMENT_DATA = [
    ...
    { id: 'PA-02', name: 'Meyer Sound USW-1P', amount: 2, description: 'Subwoofer / 35 Hz - 180 Hz / Max Peak SPL 135 dB', price: 50, category: 'PA Speakers', detailedDescription: 'Self-powered subwoofer featuring two 15-inch drivers, each powered by dedicated channels of the proprietary class AB/bridged amplifier (550 watts total peak power). Delivers flat low-frequency response with advanced limiter protection preventing driver over-excursion while allowing high output levels across the entire frequency range. Built-in low-pass crossover accepts full-range signal for simple daisychain distribution, eliminating need for external crossovers. Performs seamlessly with UPA-1P, UPA-2P and UPJ-1P loudspeakers, and compatible with other Meyer Sound self-powered systems. Ideal for concert halls, clubs, houses of worship, theatrical sound reinforcement, surround sound presentations, stage monitoring drum fill, and portable and installed audio-visual systems. Field-replaceable audio modules and amplifier/processing package with Intelligent AC system for worldwide operation.' },
    { id: 'PA-03', name: 'Meyer Sound 700-HP', amount: 2, description: 'UltraHigh-Power Subwoofer / 28 – 150 Hz / Max Peak SPL 139 dB', price: 80, category: 'PA Speakers', detailedDescription: 'Ultrahigh-power subwoofer featuring two back-vented, long-excursion 18-inch cone drivers with 4-inch voice coils (1200 AES watts each). Ultra-efficient high-gauss neodymium magnets deliver maximum output with minimal heat dissipation. Integral two-channel class AB/H amplifier with complementary MOSFET output stages supplies 2250 watts total peak power (1125W per channel), producing 3 dB more overall SPL than previous models with enormous headroom for extreme transient demands. Extremely low distortion ensures ultimate low-frequency clarity. Operating range 28 Hz to 150 Hz complements Meyer Sound loudspeakers and arrays in applications requiring maximum headroom. Stackable and flyable with optional QuickFly rigging kit (up to 11 cabinets at 7:1 safety factor). Ideal for stadiums, arenas, concert halls, medium-to-large theatres and clubs, theme parks, and cinema. Field-replaceable amplifier module and optional RMS remote monitoring. Truck-smart dimensions for transport efficiency.' },
