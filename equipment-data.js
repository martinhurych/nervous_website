...
const EQUIPMENT_DATA = [
    ...
    // Studio Speakers
    { id: 'SP-01', name: 'Genelec 7350 APM', amount: 1, description: 'Subwoofer / 8" / Peak 104 dB SPL / Power: 150 W / 22 - 120 Hz', price: 40, category: 'Studio Speakers', detailedDescription: 'Compact 8-inch active subwoofer designed for stereo and multichannel monitoring systems. Perfect for studio monitoring, post-production, and multichannel audio installations. Ideal companion for Genelec 8330 APM monitors and Fostex 6301B multichannel setups. Extends low-frequency response down to 22 Hz for accurate bass reproduction in music production, film mixing, and immersive audio applications. Smart Active Monitoring technology integrates seamlessly with Genelec GLM software for room calibration and system optimization. Compact footprint suits small to medium control rooms, home studios, and mobile production setups.' },
